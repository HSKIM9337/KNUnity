...
import com.example.knunity.databinding.ActivityBoardLikeBinding
...
class BoardLikeActivity : AppCompatActivity() {
    private val binding: ActivityBoardLikeBinding by lazy {
        ActivityBoardLikeBinding.inflate(layoutInflater)
    }
    private val myRecyclerViewAdapter: RecyclerAdapter by lazy {
        RecyclerAdapter()
    }
    private val boardDataList = mutableListOf<BoardModel>()
    private val likeDataList = mutableListOf<String>()
