...
import com.example.knunity.databinding.ActivityJobListBinding
import com.example.knunity.job.JobAdapter
...
class JobListActivity : AppCompatActivity() {
    private val binding: ActivityJobListBinding by lazy {
        ActivityJobListBinding.inflate(layoutInflater)
    }
    private val myRecyclerViewAdapter: JobAdapter by lazy {
        JobAdapter()
    }
    private val boardDataList = mutableListOf<JobModel>()
    ...
    private fun moveWrite() {
        binding.rvList.setOnClickListener{
            val intent = Intent(this, JobInsideActivity::class.java)
    ...
    private fun move_to() {
        binding.WriteIV.setOnClickListener {
            val intent = Intent(this, JobWriteActivity::class.java)
            startActivity(intent)
        }
    }
    private fun getFBBoardData() {
        ...
        FBRef.jobRef.addValueEventListener(postListener)
    }
}